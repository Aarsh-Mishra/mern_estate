...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    hidden accept='image/*'/>
      ...
      <img onClick={()=>fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt='profile' className='rounded-full h-7 w-7 object-cover cursor-pointer self-center mt-2'/>
      ...
      <input type='text' defaultValue={currentUser.username} id='username' placeholder='username' onChange={handleChange} className='border p-3 rounded-lg'/>
